...
compass = importdata('53c_compass.mat'); %Import data from simulink
rudder = importdata('53c_rudder.mat'); %Import data from simulink
reference = importdata('53c_ref.mat'); %Import data from simulink
